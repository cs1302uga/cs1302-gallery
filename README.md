...
1. **How do I parse the JSON result for a query?**
   ...
   **Before you continue,** please do some due dilligence and lookup JSON. Given a 
   ...
   1. You can parse the JSON response using the static `parseReader` method found in the
      [`JsonParser`](https://www.javadoc.io/doc/com.google.code.gson/gson/com/google/gson/JsonParser.html) class.
      The method returns a reference to a [`JsonElement`](https://www.javadoc.io/doc/com.google.code.gson/gson/com/google/gson/JsonElement.html)
